...
class GroupThisWeekStepsIndicator extends StatelessWidget {
  final int weeklyStepsGoal;

  const GroupThisWeekStepsIndicator({Key? key, required this.weeklyStepsGoal})
      : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: BlocBuilder<GroupStepsCubit, GroupStepsState>(
